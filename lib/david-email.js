...
export function confirmationEmail({ prenom, publicUrl }) {
  ...
  return wrap({
    ...
    lines: [
      ...
      '',
      'On joue 10 places Carré Or pour Hexagone MMA, le 25 septembre au Zénith.',
...
export function invitationEmail({ friendPrenom, referrerPrenom, link }) {
  ...
  return wrap({
    ...
    lines: [
      ...
      '',
      'Si tu veux tenter une place Carré Or Hexagone MMA, c’est ici :',
      link,
    ],
  });
}
...
export function shareAskEmail({ prenom, publicUrl }) {
  ...
  return wrap({
    ...
    lines: [
      ...
      '',
      'Tu es déjà inscrit pour Hexagone MMA. Si tes amis veulent tenter aussi, envoie-leur ça :',
      link,
    ],
  });
}
